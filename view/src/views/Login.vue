...
<template>
    <div class="py-12 lg:py-16 bg-gradient-to-br from-cyan-50 to-blue-200 min-h-full">
        <div class="text-center text-4xl lg:text-5xl mb-3 px-6 font-bold tracking-widest">学生管理系统</div>
        <div
            ...
            <div class="mb-8 mx-4 flex justify-center items-center lg:w-2/5">
                <div class="p-8 lg:p-12 mx-auto">
                    ...
                    <t-form>
                        <t-input size="large" label="账号" placeholder="账号" v-model="account" class="mt-12"
                            autocomplete="username">
                            <template #prefix-icon>
                                <desktop-icon />
                            </template>
                        </t-input>
                        <t-input size="large" label="密码" placeholder="密码" v-model="password" type="password"
                            class="my-6" @enter="loginRequest" autocomplete="current-password">
                            <template #prefix-icon>
                                <lock-on-icon />
                            </template>
                        </t-input>
            ...
            <div class="lg:py-20 py-10 px-12 flex-wrap lg:w-3/5">
                <p
                    ...
                    世界上没有才能的人是没有的。问题在于教育者要去发现每一位学生的禀赋、兴趣、爱好和特长，为他们的表现和发展提供充分的条件和正确引导。</p>
                <p class="pt-4 lg:pt-8 text-xl lg:text-3xl font-bold text-right text-stone-600">苏霍姆林斯基</p>
            </div>
        </div>
    </div>
</template>